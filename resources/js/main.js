...
!function (e) {
  "function" != typeof e.matches && (e.matches = e.msMatchesSelector || e.mozMatchesSelector || e.webkitMatchesSelector || function (e) {
    for (var t = this, s = (t.document || t.ownerDocument).querySelectorAll(e), o = 0; s[o] && s[o] !== t;) ++o;
    return Boolean(s[o]);
...
list.forEach(function (e) {
  ...
  t.addEventListener("click", function () {
    t.classList.toggle("active"), o.classList.toggle("text--full"), "Свернуть отзыв" === s.innerHTML ? s.innerHTML = "Раскрыть отзыв" : s.innerHTML = "Свернуть отзыв";
  });
});
let bntMenu = document.querySelector(".menu-btn"),
